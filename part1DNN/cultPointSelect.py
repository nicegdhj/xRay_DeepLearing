...
Description:  层级分类方案拿到两阶段模型的输出数据，（0.0，1.0）之间每隔0.05选取一个值作为截断点，对比选择
...
def plot_cnfMatrix(y_true, y_predict, threshold, classes=[0, 1, 2, 3], normalize=False, title='Confusion matrix',
    ...
    plt.tight_layout()
    plt.savefig(
        'D:/workCode/xRay/xRay_DeepLearing/part1DNN/tables/cultPoint2stepResult/cultPoint_table/{}_sensitive_cnf_rate.png'.format(
            threshold))
...
def plot_Curve(recall_kv, save_img_name):
    ...
    plt.savefig(
        'D:/workCode/xRay/xRay_DeepLearing/part1DNN/tables/cultPoint2stepResult/cultPoint_table/{}.png'.format(save_img_name))
...
if __name__ == '__main__':
    ...
    file1 = pd.read_csv(
        'D:/workCode/xRay/xRay_DeepLearing/part1DNN/tables/cultPoint2stepResult/2classes_record_densenet27.csv')
    file2 = pd.read_csv(
        'D:/workCode/xRay/xRay_DeepLearing/part1DNN/tables/cultPoint2stepResult/4classesData_3classes_record_densenet28.csv')

    file2_sensitive = pd.read_csv(
        'D:/workCode/xRay/xRay_DeepLearing/part1DNN/tables/cultPoint2stepResult/4classesData_3classes_record_densenet33_sensitive.csv')
    ...
    # plt.xticks(np.arange(0.05, 1, 0.05))
    plt.savefig(
        'D:/workCode/xRay/xRay_DeepLearing/part1DNN/tables/cultPoint2stepResult/cultPoint_table/curve.png')
