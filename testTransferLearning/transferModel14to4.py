...
Description:  finetune densenet121-chestRay14 (14种病)-->densenet121-chestRay14(4种病)
...
if __name__ == '__main__':
    ...
    if flags.useCheXNetPretrained:
        print("Reload cheXNet checkpoints...")
    ...
    dataLoaderTrain = DataLoader(datasetTrain, batch_size=flags.batch_size, shuffle=True, num_workers=8,
                                 pin_memory=True)
